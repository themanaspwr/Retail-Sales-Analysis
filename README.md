...
A professional, end-to-end Data Analytics and Data Science portfolio project demonstrating data cleaning, exploratory data analysis (EDA), visualization, and predictive modeling using Python inside a Jupyter Notebook.

This project is tailored for Associate Data Analyst or entry-level Data Scientist roles, showcasing practical business intelligence extraction and data preparation workflows.
...
- **Role Target**: Associate Data Analyst / Junior Data Scientist
